    ...
    <article className="group flex flex-col">
      <div
        className={[
          ...
          'ring-1 ring-signal/15 shadow-[0_0_40px_rgba(116,242,41,0.08),0_20px_50px_rgba(0,0,0,0.35)]',
        ].join(' ')}
      ...
      >
        {active ? (
          ...
          <>
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-ink/82 via-ink/10 to-ink/0" />
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(116,242,41,0.18),transparent_22%)]" />
            <div className="absolute inset-0 flex items-center justify-center">
              <span className="flex items-center justify-center w-16 h-16 md:w-20 md:h-20 bg-signal text-ink transition-transform duration-300 group-hover:scale-110 shadow-[0_0_28px_rgba(116,242,41,0.28)]">
            ...
            <a
              ...
              className="absolute top-4 right-4 w-9 h-9 inline-flex items-center justify-center bg-paper/92 text-ink hover:bg-signal hover:text-ink transition-colors"
            >
      ...
      <div className="pt-5">
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="font-mono text-[10px] uppercase tracking-[0.2em] text-signal/75">
            Analysis
          </span>
        </div>
        <h3
