  ...
  return (
    <header
      className={[
        ...
        scrolled
          ? 'bg-ink/95 backdrop-blur text-paper border-b border-signal/10 shadow-[0_12px_30px_rgba(0,0,0,0.35)]'
    ...
    >
        ...
        >
          {portraitOk ? (
            <img
              ...
              className="w-11 h-11 md:w-14 md:h-14 rounded-full object-cover object-center ring-2 ring-signal/80 shadow-[0_0_0_1px_rgba(255,255,255,0.06),0_0_24px_rgba(116,242,41,0.18)]"
            />
          ) : (
      ...
      {open && (
        <nav className="md:hidden bg-[#050905] text-paper border-t border-signal/10">
