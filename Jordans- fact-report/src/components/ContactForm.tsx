...
export default function ContactForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-10">
      ...
      <button
        type="submit"
        className="group inline-flex items-center gap-4 bg-signal text-ink px-8 py-5 text-[12px] uppercase tracking-[0.2em] font-semibold hover:bg-paper hover:text-ink transition-colors shadow-[0_0_28px_rgba(116,242,41,0.22)]"
      >
        Send message
