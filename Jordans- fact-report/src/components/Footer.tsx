...
export default function Footer() {
  ...
  return (
    <footer className="mt-24 md:mt-40 bg-navy text-paper">
      <div className="container-edge py-20 md:py-28 border-b border-signal/12">
        ...
        <div className="col-span-2 md:col-span-5">
          <div className="mb-5 flex items-center gap-4">
            <img
              ...
              alt={SITE.network}
              className="w-14 h-14 md:w-16 md:h-16 rounded-full object-cover object-center ring-2 ring-signal/80 shadow-[0_0_24px_rgba(116,242,41,0.18)]"
