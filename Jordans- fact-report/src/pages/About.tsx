      ...
      <section className="container-edge pb-24 md:pb-32 grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16">
        <div className="md:col-span-5 md:sticky md:top-28 md:self-start">
          <figure className="relative">
            <div className="aspect-[4/5] w-full bg-bone overflow-hidden border border-signal/20 shadow-[0_0_50px_rgba(116,242,41,0.14),0_30px_80px_rgba(0,0,0,0.45)]">
              <img
        ...
        <div className="md:col-span-7 space-y-6 text-lg md:text-[21px] leading-[1.5] text-paper/85 tracking-[-0.003em]">
          ...
          <div className="pt-12">
            <Link
              to="/work"
              className="inline-flex items-center gap-3 bg-signal text-ink px-6 py-4 text-[12px] uppercase tracking-[0.2em] font-semibold hover:bg-paper hover:text-ink transition-colors shadow-[0_0_28px_rgba(116,242,41,0.22)]"
            >
