...
export default function Home() {
  ...
  return (
    <>
        ...
        <div className="flex gap-16 marquee whitespace-nowrap font-mono text-[11px] uppercase tracking-[0.24em] text-paper/70">
          {marquee.map((b, i) => (
            <span key={i} className="shrink-0 flex items-center gap-16">
              <span className="w-1 h-1 bg-gold rounded-full shadow-[0_0_16px_rgba(116,242,41,0.35)]" />
              {b}
            </span>
          ))}
        </div>
      ...
      <section className="bg-[linear-gradient(180deg,#050905_0%,#071007_100%)] border-b border-paper/10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12">
            <div className="lg:col-span-7">
              ...
              <h2 className="display font-semibold text-4xl sm:text-5xl md:text-6xl lg:text-[76px] leading-[1.0] tracking-[-0.04em] text-paper max-w-5xl">
                The newest upload, front and center, with the key argument laid out before you press play.
              </h2>
            </div>
            <div className="lg:col-span-5 lg:pl-8 lg:border-l lg:border-paper/10">
              ...
              <p className="text-paper/78 text-base leading-relaxed max-w-xl">
                This version of the site is structured like a current-issue briefing: one main story, supporting items, and a cleaner archive pulled around Jordan&apos;s latest uploads.
              </p>
            </div>
          </div>
          ...
          <div className="mt-14 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-5 space-y-8">
              {secondary.map((video, index) => (
                <article key={video.id} className="border border-signal/14 bg-paper/[0.03] p-5 md:p-6 shadow-[0_0_32px_rgba(116,242,41,0.05)]">
                  <div className="mb-5">
      ...
      <section className="bg-[linear-gradient(180deg,#071007_0%,#040904_100%)] border-b border-paper/10">
        <div className="container-edge py-20 md:py-28">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="border border-signal/14 bg-black/30 p-5 shadow-[0_0_32px_rgba(116,242,41,0.05)]">
                <p className="font-mono text-[10px] uppercase tracking-[0.22em] text-signal mb-3">Base</p>
                <p className="text-paper font-semibold text-2xl tracking-tight mb-2">London</p>
                <p className="text-paper/72 text-sm leading-relaxed">Based in London, with a fast-turn commentary desk focused on political accountability and headline analysis.</p>
              </div>
              <div className="border border-signal/14 bg-black/30 p-5 shadow-[0_0_32px_rgba(116,242,41,0.05)]">
                ...
                <p className="text-paper/72 text-sm leading-relaxed">Sharp commentary, quick context, and a clear focus on what the record actually supports.</p>
              </div>
              <div className="border border-signal/14 bg-black/30 p-5 shadow-[0_0_32px_rgba(116,242,41,0.05)]">
                <p className="font-mono text-[10px] uppercase tracking-[0.22em] text-signal mb-3">Coverage</p>
                <p className="text-paper font-semibold text-2xl tracking-tight mb-2">UK Politics</p>
                <p className="text-paper/72 text-sm leading-relaxed">Parliament, leadership pressure, public fallout, and the stories dominating the political timeline.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="container-edge py-20 md:py-28">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 mb-12">
          ...
          <Link
            to="/work"
            className="inline-flex items-center gap-3 bg-signal text-ink px-6 py-4 text-[12px] uppercase tracking-[0.2em] font-semibold hover:bg-paper hover:text-ink transition-colors self-start md:self-end shadow-[0_0_28px_rgba(116,242,41,0.22)]"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {recent.map((video, index) => (
            <article key={video.id} className="border border-signal/14 bg-black/25 p-5 md:p-6 shadow-[0_0_32px_rgba(116,242,41,0.05)]">
