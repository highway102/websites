...
export default function VideoCard({ video, index, large }: Props) {
  ...
  return (
    <article className="group flex flex-col">
      <div
        className="relative w-full aspect-video bg-ink overflow-hidden cursor-pointer ring-1 ring-ink/5"
      ...
      <div className="pt-5">
        ...
        <h3 className={[
          'font-display font-semibold tracking-[-0.01em] text-ink leading-[1.2]',
