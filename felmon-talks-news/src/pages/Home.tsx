          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12">
            ...
            <div className="lg:col-span-5 lg:pl-8 lg:border-l lg:border-paper/10">
              ...
              <p className="text-paper/78 text-base leading-relaxed max-w-xl">
                This version of the site is structured like a current-issue briefing: one main story, supporting items, and a cleaner archive beneath it.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="border border-paper/10 bg-black/30 p-5">
                ...
                <p className="text-paper font-semibold text-2xl tracking-tight mb-2">Chicago</p>
                <p className="text-paper/72 text-sm leading-relaxed">Based in Chicago, Illinois with a fast-turn independent commentary desk built around political analysis and headline accountability.</p>
              </div>
              <div className="border border-paper/10 bg-black/30 p-5">
              ...
              <div className="border border-paper/10 bg-black/30 p-5">
                ...
                <p className="text-paper/72 text-sm leading-relaxed">Politics, media accountability, party fracture, and the stories dominating the timeline.</p>
              </div>
            </div>
          </div>
        </div>
