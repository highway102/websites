    ...
    >
      <div className="container-edge flex h-[68px] md:h-[80px] items-center justify-between">
        ...
        >
          ...
          <span className="hidden sm:inline font-sans text-[14px] md:text-[15px] font-semibold tracking-tight">
            {SITE.name}
          </span>
        </Link>
            ...
            {links.map((l) => (
              <li key={l.to}>
                <NavLink
                  ...
                  className={({ isActive }) =>
                    [
                      'block py-4 text-xl font-semibold tracking-tight border-b border-ink/10',
