...
export default function ContactForm() {
  ...
  const field =
    'w-full bg-transparent border-0 border-b border-ink/20 focus:border-ink outline-none py-4 text-ink placeholder:text-ink/30 text-lg md:text-xl font-medium tracking-tight'
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-10">
      ...
      <button
        type="submit"
        className="group inline-flex items-center gap-4 bg-ink text-paper px-8 py-5 text-[12px] uppercase tracking-[0.2em] font-semibold hover:bg-signal transition-colors"
      >
        Send message
