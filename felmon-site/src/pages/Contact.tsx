        ...
        <aside className="md:col-span-5 md:pl-12 md:border-l md:border-ink/15 space-y-14">
          <div>
            ...
            <a
              ...
              className="group inline-flex items-baseline gap-3 font-semibold text-2xl md:text-3xl text-ink tracking-[-0.02em] break-all"
            >
          ...
          <div>
            ...
            <p className="text-ink font-semibold text-xl tracking-tight">{SITE.location}</p>
          </div>
              ...
              {socialLinks.map((s) => (
                <li key={s.label}>
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="group inline-flex items-center gap-2 text-ink font-semibold text-lg tracking-tight"
                  >
