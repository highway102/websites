  ...
  return (
    <>
      ...
      <section className="container-edge pb-24 md:pb-32 grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16">
        ...
        <div className="md:col-span-5 md:sticky md:top-28 md:self-start">
          <figure className="relative">
            ...
            <figcaption className="mt-4 flex justify-between font-mono text-[11px] uppercase tracking-[0.18em] text-ink/60">
              <span>{SITE.name}</span>
              <span className="text-gold">FTN</span>
            </figcaption>
          </figure>
          ...
          <dl className="mt-10 space-y-6 font-mono text-xs uppercase tracking-[0.14em]">
            ...
            <div>
              ...
              <dd className="text-ink text-sm">Felmon's Talk Show</dd>
            </div>
            <div>
              <dt className="text-ink/40 mb-1">Network</dt>
              <dd className="text-ink text-sm">Felmon Talks News (FTN)</dd>
            </div>
            <div>
              ...
              <dd>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="text-ink text-sm link-underline"
                >
        ...
        {/* Bio */}
        <div className="md:col-span-7 space-y-6 text-lg md:text-[21px] leading-[1.5] text-ink/85 tracking-[-0.003em]">
          ...
          <div className="pt-12 grid grid-cols-1 sm:grid-cols-2 gap-10">
            <div>
              ...
              <ul className="space-y-0">
                {SITE.beats.map((b) => (
                  <li key={b} className="py-3 border-b border-ink/10 text-ink font-semibold tracking-tight text-lg flex items-center gap-3">
              ...
              <div>
                ...
                <ul className="space-y-0">
                  {realCredentials.map((c) => (
                    <li key={c} className="py-3 border-b border-ink/10 text-ink/85 text-sm leading-relaxed">
                      {c}
                    </li>
                  ))}
                </ul>
          ...
          <div className="pt-12">
            <Link
              to="/work"
              className="inline-flex items-center gap-3 bg-ink text-paper px-6 py-4 text-[12px] uppercase tracking-[0.2em] font-semibold hover:bg-signal hover:text-ink transition-colors"
            >
