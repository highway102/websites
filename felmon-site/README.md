...
Replace `public/headshot.jpg` with your own. Any aspect ratio works but **square or portrait reads best** (the About page crops to a square). Recommended: 1200×1200 JPG, under 300KB.
...
- **Palette:** ink `#0A0A0A`, paper `#FAFAF7`, navy accent `#0F2744`.
